# Technical research for future references

1. [Automate deployment with Capistrano 3](https://github.com/rotati/wiki/wiki/Automate-deployment-with-Capistrano-3)
2. [Auto start service when Unix System boots up](https://github.com/somethvictory/wiki/wiki/Auto-start-service-when-Unix-System-boots-up)
